  ...
  <div class="project">
    <dl>
      <dt>
        ...
        <div class="title">Airbnb를 모티브로한 팀 프로젝트</div>
      ...
      <dd>
        ...
        <dl class="service">
          ...
          <dd>쿼리파라미터(페이지네이션, 오더링)를 이용한 페이지네이션 구현</dd>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, JSX, Redux, CRA</p>
            <p><strong>Back-End</strong> Node.js, Express, MySQL, jest, aws(EC2)</p>
            <p><strong>Tool</strong> Notion, Slack, Trello</p>
          </dd>
        </dl>
      </dd>
    </dl>
    <dl>
      <dt>
        ...
        <div class="title">Aesop을 모티브로한 팀 프로젝트</div>
      ...
      <dd>
        ...
        <dl class="service">
          ...
          <dd>정규집에 맞는 아이디 및 비밀번호 일치시 계정 생성</dd>
    ...
    <dl>
      <dt>
        ...
        <div class="title">네이버 모바일 메인 페이지 클론코딩</div>
      ...
      <dd>
        ...
        <div class="img">
          <img src="/assets/img/project-naver.png" alt="원티드 프론트엔드코스 기업협업 과제" />
        </div>
        <div class="info">포털사이트 네이버 모바일 버전을 클론코딩 하였습니다. 실제 서비스되는 화면과 최대한 비슷하게 작업하였으며, 스프라이프 기법 및 반응형 웹을 적용하였습니다. 현재는 네이버 검색 API를 활용하여 연관검색어 및 마이페이지 추가 기능을 구현하고 있습니다.</div>
        <dl class="service">
          <dt>주요 기능</dt>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, JSX, SASS, React Router</p>
            <p><strong>Tool</strong> Git</p>
          </dd>
        </dl>
      </dd>
    </dl>
    <dl>
      <dt>
        ...
        <div class="title">실시간 검색창 구축 및 Vercel에 배포</div>
        <div class="date">2022.08.12 ~ 2022.8.26</div>
      </dt>
      <dd>
        <div class="link">
        ...
        <div class="info">프리온보딩 프로젝트중 하나로써 검색창에 질환명 검색시 실시간으로 API 호출 통해서 검색어를 추천해주는 UI를 구현하였습니다. 정규표현식/캐싱/리액트 최적화 등 여러가지 기술들을 경험 할 수 있었던 프로젝트입니다. 무엇보다 실시간으로 JSON Server를 동작하기 위해 AWS에 직접 배포하는 과정이 기억에 남았습니다.</div>
        <dl class="service">
          <dt>주요 기능</dt>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, JSX, Sass, CRA</p>
            <p><strong>Back-End</strong> Node.js, Express, aws(EC2)</p>
          </dd>
        </dl>
      </dd>
    </dl>
    <dl>
      <dt>
        ...
        <div class="title">원티드 프리온보딩 선발 과제(로그인/회원가입, TodoList)</div>
      ...
      <dd>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, JSX, React Router, Sass</p>
            <p><strong>Tool</strong> Git</p>
          </dd>
        </dl>
      </dd>
    ...
    <dl>
      <dt>
        ...
        <div class="title">GitHub 이슈 리스트/상세 내용 패널 제작</div>
      ...
      <dd>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, TypeScript, JSX, React Router, Styled-component</p>
            <p><strong>Tool</strong> Git</p>
          </dd>
        </dl>
      </dd>
    ...
    <dl>
      <dt>
        <img src="/assets/img/logo-onboarding.png" alt="onboarding logo" />
        <div class="title">B2C 차량대여 서비스 모바일 웹 제작</div>
      ...
      <dd>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, TypeScript, JSX, React Query, Styled-Component</p>
            <p><strong>Tool</strong> Git</p>
          </dd>
        </dl>
      </dd>
    ...
    <dl>
      <dt>
        <img src="/assets/img/logo-onboarding.png" alt="onboarding logo" />
        <div class="title">B2C 투자 관리 서비스의 관리자 페이지 구현</div>
    ...
    <dl>
      <dt>
        <img src="/assets/img/logo-onboarding.png" alt="onboarding logo" />
        <div class="title">광고현황 대시보드 및 광고관리 서비스</div>
      ...
      <dd>
        ...
        <dl class="skill">
          <dt>기술 스택</dt>
          <dd>
            <p><strong>Front-End</strong> JavaScript, React, JSX, Redux-toolkit, Recharts, Styled-Components</p>
          </dd>
        </dl>
      </dd>
    </dl>
